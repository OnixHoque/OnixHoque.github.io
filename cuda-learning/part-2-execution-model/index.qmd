...
dcgmi profile --pause
ncu --set full --import-source yes --section SourceCounters -o ./prof/1_specialized_warp ./bin/1_specialized_warp 1000

ncu --metrics "regex:.*branch.*" -o ./prof/1_specialized_warp ./bin/1_specialized_warp
