...
At **MLSys 2025**, I presented a generalized method for expressing KGE training models through sparse matrix multiplication to improve large-scale efficiency. This led to a speedup of up to 5.3x in CPU performance, 4.2x in GPU model training, and an improvement of up to 11.1x in CUDA memory efficiency.  
...
* [Amazon Summer Internship 2025: Developed Differentiable GPU Kernel Autotuner. Achieved up to 60% higher accuracy in predicting optimal GPU kernel configurations compared to 16 other autotuning models.](/research/systems/gpu-tuner-amazon/index.qmd)
