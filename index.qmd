...
description: "PhD Candidate at Texas A&amp;M | ML Systems & Performance Optimization | Scalable and Differentiable Sparse Kernels for Graph Learning"
toc: false
format: 
  html:
    page-layout: full
...
Prior to my PhD, I was a tenure-track faculty member, [teaching](/teaching/) undergraduate courses over **5+ years** spanning computer systems, theory, and core programming, including **Computer Architecture**, Theory of Computation, **Programming Languages (C/C++/Java)**, and Data Structures & Algorithms. 
...
> Explore my 20+ [research projects](/research/index.qmd), browse the full list of [publications](/news/#category=Publication), or catch up on the latest [news](/news/index.qmd).
