...
description: "PhD Candidate at Texas A&amp;M | ML Systems & Performance Optimization | Sparse Kernels for Graph Learning | Tenure-Track Faculty (On Sabbatical, Industry Focus)"
toc: false
format: 
  html:
    page-layout: full
...
I am a PhD candidate in Computer Science & Engineering at Texas A&M University, focusing on **high-performance and distributed machine learning systems**. I specialize in optimizing **sparse linear algebra** for efficient ML pipelines. Previously, I interned at **Amazon AWS**, where I built a differentiable GPU kernel autotuner that reduced LLM kernel-tuning time from **days to hours** using transfer learning. Prior to my PhD, I was a [tenure-track faculty member](/teaching/), teaching undergraduate courses spanning computer systems, theory, and core programming, including **Computer Architecture**, Theory of Computation, **Programming Languages (C/C++/Java)**, and Data Structures & Algorithms. 
...
> Explore our 20+ [research projects](/research/index.qmd), browse the full list of [publications](/news/#category=Publication), or catch up on the latest [news](/news/index.qmd).
...
I deepen my ML systems expertise by solving [LeetGPU](/leetgpu/) problems across PyTorch, CUDA, and Triton, building intuition for low-level kernel design and performance trade-offs. I stay current with ML infrastructure and systems trends by developing small experimental tools and continuously expanding my [software](/software/) skill set, with 12+ open-source and commercial projects in Python, C++, and Java. I also regularly read and distill recent ML systems papers, sharing hands-on tutorials and technical walkthroughs on my [blog](/blog/) to communicate systems concepts clearly and effectively. 
