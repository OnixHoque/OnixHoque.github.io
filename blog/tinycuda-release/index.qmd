...
description: "TinyCUDA is a header-only C++17 wrapper that eliminates CUDA boilerplate—auto-handles cudaMalloc/cudaMemcpy via Buffer, kernel errors with CUDA_CHECK, and timings via KernelProfiler. Ideal for rapid 1D buffer prototyping without full-framework overhead (no autograd or multi-D tensors)."
categories: ["Project"] 
author: "Md Saidul Hoque Anik"
date: "12/26/2025"
---

> 📌 GitHub Link: [https://github.com/OnixHoque/tinyCUDA](https://github.com/OnixHoque/tinyCUDA).<br>
> 🌟 Please leave a star if you like it!

![](tinycuda.png){.lightbox}
