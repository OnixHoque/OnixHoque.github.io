...
The new MoEEPLayer ultimately became part of **FlashInfer [v0.6.16](https://flashinfer.ai/releases/#v0-6-16)**, bringing the unified abstraction and its collection of MoE-EP backends into the production FlashInfer stack. I also authored the **vLLM PR (**[#49636](https://github.com/vllm-project/vllm/pull/49636)) **integrating FlashInfer’s MoEEPLayer** as a new MegaMoE backend; and separately oversaw **MoEEPLayer** integration into **SGLang**, extending the impact of the work beyond FlashInfer itself.
